...
public class MainActivity extends AppCompatActivity
    ...
    private void setupViewPager(ViewPager mViewPager) {
       ...
       // adapter.addFragment(new mainpagefragment(),"mainpagefragment");
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if(id == R.id.Home){
            ...
            Intent i = new Intent(MainActivity.this, Tabloid.class);
            startActivity(i);
        ...
        if (id == R.id.gpa1) {
            ...
            Fragment fragment;
            Toast.makeText(getApplicationContext(), "2013-14Batch Selected", Toast.LENGTH_SHORT).show();
            fragment = new batch1();
            if (fragment != null) {
                FragmentManager fragmentManager = getSupportFragmentManager();
                FragmentTransaction fragmentTransaction = fragmentManager.beginTransaction();
            ...
            }}else if(id==R.id.gpa2) {
            Toast.makeText(getApplicationContext(), "2015-16 Batch Selected", Toast.LENGTH_SHORT).show();
            Fragment fragment;
            fragment = new batch2();
            if (fragment != null) {
                FragmentManager fragmentManager = getSupportFragmentManager();
